...
According to the data there was 1,248 movies released in 1995. There is one movie per row and 1,248 rows. 


### 2. Which Comedies with an MPAA rating, over 120 minutes have a rating above 8?

```{r}
movies_comedies_rating_length <- movies %>%
  filter(Comedy == 1 & length >= 120 & rating >= 8.0 & mpaa %in% c("R", "PG-13", "PG", "G"))
movies_comedies_rating_length
```

There are only 10 movies that fit under the filters of a comedy movie longer than two hours and have an MRAA rating higher than 8.0. 
...
There are only three Harry Potter movies in this data set. Their names are "Harry Potter and the Chamber of Secrets", "Harry Potter and the Prisoner of Azkaban", and "Harry Potter and the Sorcerer's Stone." The highest rated is "Harry Potter and the Prisoner of Azkaban" but the most voted for on imdb.com was "Harry Potter and the Sorcerer's Stone."
...
Using the filters Animation or Comedy, with at least 100 votes, that recieved the highest budget we get the answer "Wild Wild West." 
